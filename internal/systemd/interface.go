...
type Descriptor struct {
	...
	PrettyHostname             any      `json:"PrettyHostname,omitempty"`
	...
	OperatingSystemCPEName     any      `json:"OperatingSystemCPEName,omitempty"`
	...
	MachineInformationData     []any    `json:"MachineInformationData,omitempty"`
	...
	VSockCID                   any      `json:"VSockCID,omitempty"`
}
